...
<div class="row justify-content-center mt-5">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">Update User Account Information</div>
            ...
            <div class="card-body">
                ...
                <div class="d-flex" >
                    ...
                    <form action="{{ route('users.destroy', $user) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger mr-2"> Delete this user</button>
                     </form>
                     @endif 
                 <a href="{{ route('users.index') }}" class="btn-primary rounded-1 text-decoration-none btn btn-secondary">  Back  </a>
